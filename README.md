...
- ical import/export
- calendar options: edit name, 12 color palette, share with view only access, authorization (password/2FA), remove from list, delete
- support 2FA tokens as alternative to passwords
